...
sealed interface SemesterPhase {
    ...
    /** 学期尚未开始；[startDate] 是教务 option 的名义开学日，供「距开学 X 天」倒计时。 */
    data class NotStarted(val startDate: LocalDate) : SemesterPhase
    ...
    companion object {
        ...
        fun at(semesterStart: LocalDate?, totalWeeks: Int, today: LocalDate): SemesterPhase? {
            ...
            if (today.isBefore(monday)) return NotStarted(semesterStart)
